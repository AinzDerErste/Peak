...
using Notch.App.Views.Widgets;
using System.Windows.Shapes;
using Notch.Core.Configuration;
using Notch.Core.Services;
using Notch.Platform.Native;

namespace Notch.App.Views;
...
public partial class IslandWindow : Window
{
    ...
    private void OnIslandDrop(object sender, DragEventArgs e)
    {
        ...
        foreach (var path in files)
        {
            ...
            _viewModel.QuickAccessItems.Add(new Notch.Core.Models.QuickAccessItem
            {
                Path = path,
                Name = name,
                IsFolder = isFolder
