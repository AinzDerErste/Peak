...
#define MyAppExeName "Notch.App.exe"
#define MyAppURL "https://github.com/peak"

#define PublishDir "..\src\Notch.App\bin\Release\net8.0-windows10.0.22621.0\publish"
#define IconFile "..\src\Notch.App\Assets\app-icon.ico"
